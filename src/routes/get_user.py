...
from src.creds import get_creds, Creds
...
@oxusers.get(
    ...
    responses = {
        200: {
            "description": "Get a user from his e_mail"
        },
        403: {
...
async def get_user(
    ...
    if user_id != 'toto@example.com' and user_id != 'd437abd5-2b49-47db-be49-05f79f1cc242':
        raise HTTPException(status_code=404, detail='User not found')

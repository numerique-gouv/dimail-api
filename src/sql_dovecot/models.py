...
class DovecotUser(Dovecot):
  __tablename__='users'
  username = Column(String(128, collation='ascii_bin'), nullable=False, primary_key=True)
  domain   = Column(String(128, collation='ascii_bin'), nullable=False, primary_key=True)
